...
export function ResultCard({ documento, consulta }: { documento: Documento; consulta: string }) {
  const ficha = `/documento/${encodeURIComponent(documento.id)}?de=${encodeURIComponent(consulta)}`;
  return (
